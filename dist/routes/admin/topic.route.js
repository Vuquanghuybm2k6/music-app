...
router.post("/create", upload.single("avatar"), validate.createPost, uploadCloud.uploadSingle, controller.createPost);
router.get("/detail/:id", controller.detail);
router.get("/edit/:id", controller.edit);
router.patch("/edit/:id", upload.single("avatar"), validate.editPatch, uploadCloud.uploadSingle, controller.editPatch);
